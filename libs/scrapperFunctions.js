...
const getArrayWithInputData = async (url) => {
...
const getSoldListingHistory = async (url) => {
...
module.exports = { getArrayWithInputData, createURL, getSoldListingHistory };
